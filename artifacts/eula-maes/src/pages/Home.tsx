...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-colors duration-300 ${scrolled ? 'bg-[#1A0A00] shadow-md py-4' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 flex items-center justify-between">
        <div className="text-white font-serif text-2xl font-bold cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          Eula Mae's
        </div>
        
        <div className="hidden md:flex space-x-8 text-white font-sans text-sm tracking-widest uppercase">
          <button onClick={() => scrollTo('story')} className="hover:text-[#C8392B] transition-colors">Our Story</button>
          <button onClick={() => scrollTo('reviews')} className="hover:text-[#C8392B] transition-colors">Reviews</button>
          <button onClick={() => scrollTo('menu')} className="hover:text-[#C8392B] transition-colors">Menu</button>
          <button onClick={() => scrollTo('reserve')} className="hover:text-[#C8392B] transition-colors">Reserve</button>
        </div>
...
export default function Home() {
  ...
  return (
    <div className="bg-[#F5EFE0] min-h-screen text-[#1A0A00] font-sans selection:bg-[#C8392B] selection:text-white">
      ...
      <section className="relative h-[100dvh] flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center mt-16">
          <motion.h1 
            ...
            className="font-serif text-white text-5xl md:text-7xl lg:text-[80px] leading-[1.1] tracking-wide mb-6"
          >
          ...
          <motion.p 
            ...
            className="text-[#F5EFE0] text-lg md:text-xl font-medium tracking-wide mb-10"
          >
          ...
          >
            <Button 
              ...
              size="lg"
              className="bg-[#C8392B] hover:bg-[#A62F24] text-white rounded-full px-8 py-7 text-lg font-medium tracking-wide transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1"
            >
      ...
      {/* Story Section */}
      <section id="story" className="relative py-24 md:py-32 px-6 bg-white overflow-hidden">
        <FaintCardinal />
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-serif text-4xl md:text-5xl leading-tight mb-8 text-[#1A0A00]">
                Named for the woman who taught us everything
              </h2>
              
              <div className="space-y-6 text-[#1A0A00] text-lg leading-relaxed">
                <p>
              ...
              <blockquote className="mt-10 pl-6 border-l-4 border-[#C8392B]">
                <p className="font-serif italic text-[#C8392B] text-2xl md:text-3xl leading-snug">
                  "I may not be able to cook with my mom anymore — but I can cook for a few hundred people in her name."
                </p>
              </blockquote>
              
              <p className="mt-6 text-[#6B4C2A] italic text-base">
      ...
      {/* Reviews Section */}
      <section id="reviews" className="py-24 px-6 bg-[#F5EFE0]">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <motion.h2 
              ...
              viewport={{ once: true }}
              className="font-serif text-4xl md:text-5xl text-[#6B4C2A] mb-4"
            >
              A few words from our guests
            </motion.h2>
            <p className="font-serif text-[#C8392B] text-xl md:text-2xl mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {reviews.map((review, i) => (
              <motion.div 
                ...
                className="bg-[#FFF8EC] p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow"
              >
                <div className="text-[#C8392B] tracking-widest text-lg mb-4">
                  ★★★★★
                </div>
                <p className="text-[#1A0A00] mb-6 leading-relaxed flex-grow">
                  "{review.text}"
                </p>
      ...
      {/* Menu Section */}
      <section id="menu" className="py-24 px-6 bg-[#1A0A00] text-[#F5EFE0]">
        <div className="container mx-auto max-w-7xl">
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="font-serif text-4xl md:text-5xl text-white text-center mb-16"
          >
            What's Cooking
          </motion.h2>
          ...
          <div className="grid md:grid-cols-3 gap-12 lg:gap-16 mb-20">
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <h4 className="font-bold text-[#FFF8EC] text-xl">Eula Mae's Special</h4>
                    <span className="text-[#C8392B] font-medium">$12</span>
                  </div>
                  <p className="text-[#F5EFE0]/80">The dish that started it all. Ask your server.</p>
                </div>
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <h4 className="font-bold text-[#FFF8EC] text-xl">Wings</h4>
                    <span className="text-[#C8392B] font-medium">$10</span>
                  </div>
                  <p className="text-[#F5EFE0]/80">Crispy, sauced, and worth every napkin.</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <h4 className="font-bold text-[#FFF8EC] text-xl">Ribeye Sandwich</h4>
                    <span className="text-[#C8392B] font-medium">$18</span>
                  </div>
                  <p className="text-[#F5EFE0]/80">A half-pound of ribeye on a toasted brioche bun. No substitutions.</p>
                </div>
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <h4 className="font-bold text-[#FFF8EC] text-xl">Hamburger Steak</h4>
                    <span className="text-[#C8392B] font-medium">$15</span>
                  </div>
                  <p className="text-[#F5EFE0]/80">Southern classic. Smothered in onion gravy.</p>
                </div>
              </div>
            </div>
            ...
            {/* Desserts */}
            <div>
              <h3 className="font-serif text-2xl text-white border-b border-[#6B4C2A]/40 pb-4 mb-6">Desserts & Sides</h3>
              <div className="space-y-8">
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                ...
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <h4 className="font-bold text-[#FFF8EC] text-xl">Red Velvet Cake</h4>
                    <span className="text-[#C8392B] font-medium">$6</span>
                  </div>
                  <p className="text-[#F5EFE0]/80">Three layers. Cream cheese frosting. Grandma-level.</p>
                </div>
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <h4 className="font-bold text-[#FFF8EC] text-xl">Fresh Biscuits w/ Apple Butter</h4>
                    <span className="text-[#C8392B] font-medium">$4</span>
                  </div>
                  <p className="text-[#F5EFE0]/80">Made every morning. While they last.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="italic mb-10 text-lg">Full menu available in-house. Something for everyone — made from scratch.</p>
            <Button 
              onClick={scrollToReserve}
              size="lg"
              className="bg-[#C8392B] hover:bg-[#A62F24] text-white rounded-full px-10 py-6 text-lg font-medium tracking-wide transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
            >
      ...
      {/* Reserve Section */}
      <section id="reserve" className="py-24 px-6 bg-[#F5EFE0]">
        <div className="container mx-auto max-w-5xl">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="font-serif text-4xl md:text-5xl text-[#1A0A00] mb-8 leading-tight">
                We'd love to have you at our table.
              </h2>
              
              <div className="space-y-6 text-[#1A0A00] text-lg">
                <div>
            ...
            <div className="bg-white p-8 md:p-10 rounded-2xl shadow-xl">
              <a 
                href="tel:2563924999" 
                className="w-full block text-center bg-[#C8392B] hover:bg-[#A62F24] text-white rounded-full px-6 py-5 text-xl font-medium tracking-wide transition-all shadow-md hover:shadow-lg mb-10"
              >
                📞 Call to Reserve — (256) 392-4999
              </a>
      ...
      <footer className="bg-[#1A0A00] py-16 px-6 text-[#F5EFE0] text-center border-t border-[#6B4C2A]/20">
        <div className="container mx-auto flex flex-col items-center">
          ...
          <h2 className="font-serif text-3xl mb-4">Eula Mae's</h2>
