      ...
      <div className="container mx-auto px-4 sm:px-6 py-12 md:py-20 max-w-3xl">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {activeTab === 'lunch' && (
              <div>
                <p className="font-serif italic text-[#6B4C2A] text-lg mb-8">Mon – Fri · 11:00am – 2:00pm</p>
            ...
            {activeTab === 'dinner' && (
              <div>
                <p className="font-serif italic text-[#6B4C2A] text-lg mb-8">Mon – Fri · 4:30pm – 9:00pm · Entrees served with two sides.</p>
